defmodule BrasilEmDadosWeb.UserAuthTest do
  use BrasilEmDadosWeb.ConnCase, async: true

  alias BrasilEmDados.Accounts
  alias BrasilEmDadosWeb.UserAuth
  import BrasilEmDados.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BrasilEmDadosWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BrasilEmDadosWeb.Endpoint.subscribe(live_socket_id)
