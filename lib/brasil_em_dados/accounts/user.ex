defmodule BrasilEmDados.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, BrasilEmDados.Repo)
  ...
  """
  def valid_password?(%BrasilEmDados.Accounts.User{hashed_password: hashed_password}, password)
